...
void update(t_data *game)
{
    ...
    {
		rotation_angle = game->player.turndirection * 0.005; 
        rotate_player(game, rotation_angle);
    }
    if (game->player.walkdirection != 0)
    {
        new_x = game->player.pos[0] + game->player.dir[0] * (game->player.walkdirection * game->player.movespeed);
        new_y = game->player.pos[1] + game->player.dir[1] * (game->player.walkdirection * game->player.movespeed);
    ...
    {
        new_x = game->player.pos[0] + (-game->player.dir[1]) * (game->player.strafedirection * game->player.movespeed);
        new_y = game->player.pos[1] + game->player.dir[0] * (game->player.strafedirection * game->player.movespeed);
